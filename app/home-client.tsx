...
interface HomeClientProps {
  initialCars: InitialCarsPayload;
  initialFilterOptions: FilterOptions;
  initialMessage?: string;
  initialPurchaseOption: PurchaseOption;
}
...
export default function HomeClient({
  ...
  const [cars, setCars] = useState<CarOfferView[]>(initialCars.cars);
  const [purchaseOption, setPurchaseOption] =
    useState<PurchaseOption>(initialPurchaseOption);
  ...
  const [listUpdatedAt, setListUpdatedAt] = useState<string | null>(
    initialCars.listUpdatedAt || null,
  );
  ...
  const [pagination, setPagination] = useState<{
    ...
    page: initialCars.page,
    pageSize: normalizePageSize(initialCars.pageSize, "30"),
    total: initialCars.total,
    totalPages: initialCars.totalPages,
  });
          ...
          <div className="relative min-h-24">
            {cars.length === 0 && loadState !== "loading" ? (
              ...
              <div className="grid gap-3">
                ...
                const hasDetails = hasChart || car.availabilityHistory.length > 0;
                  ...
                  >
                    <div className="grid gap-4 md:grid-cols-[150px_1fr_auto]">
                      ...
                      <div className="min-w-0">
                        ...
                        <dl className="mt-3 grid gap-2 text-sm text-slate-300 sm:grid-cols-8">
                          <div>
                    ...
                    {isSelected && hasDetails && (
                      <div className="mt-4 border-t border-slate-800 pt-4">
                        ...
                        {car.availabilityHistory.length > 0 && (
                          <div className={hasChart ? "mt-4" : ""}>
                            <h4 className="text-sm font-semibold text-white">
                              Historia dostępności
                            </h4>
                            <div className="mt-3 grid gap-2 sm:grid-cols-2">
                              {car.availabilityHistory.map((event) => (
                                <div
